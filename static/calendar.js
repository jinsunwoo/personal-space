...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function N(n, l, u, i, t) {
        var r, o, f, e, c;
        if (t ? "className" === l && (l = "class") : "class" === l && (l = "className"), "style" === l) if (r = n.style, "string" == typeof u) r.cssText = u; else {
    ...
    function M(n) {
        var l = {}, u = {
            __c: "__cC" + f++, __: n, Consumer: function (n, l) {
                return n.children(l)
            }, Provider: function (n) {
                var i, t = this;
        ...
        */
        CalendarContent.prototype.render = function () {
            ...
            return (createElement(ViewContextType.Provider, {value: viewContext},
                ...
                createElement(Toolbar, __assign({
                    ref: this.headerRef,
                ...
                for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                    ...
                    */
                    nodes.push(createElement("div", {
                        ...
                        createElement(TableListItemEvent, __assign({
                            seg: seg,
                            isDragging: isDragging,
                            isSelected: instanceId === eventSelection,
                            defaultDisplayEventEnd: defaultDisplayEventEnd
                        }, getSegMeta(seg, todayRange))) :
                        createElement(TableBlockEvent, __assign({
                            seg: seg,
                            isDragging: isDragging,
